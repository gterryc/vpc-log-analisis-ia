...
resource "aws_security_group" "web" {
  name_prefix = "${var.tags.Project}-web-"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "attack_simulator" {
  name_prefix = "${var.tags.Project}-attack-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = merge(var.tags, {
    Name = "${var.tags.Project}-attack-sg"
  })
}
...
resource "aws_flow_log" "main" {
  ...
  tags = merge(var.tags, {
    Name = "${var.tags.Project}-flow-logs"
  })
}

# IAM Role para Flow Logs
resource "aws_iam_role" "flow_log" {
  name_prefix = "${var.tags.Project}-flow-log-"
