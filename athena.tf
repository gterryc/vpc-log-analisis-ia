...
# Propósito principal: Port Scanning
...
# Propósito principal: DDOS Detection
# Identifica direcciones IP de destino que están recibiendo un volumen inusualmente alto de tráfico o conexiones desde múltiples fuentes.
...
# Propósito principal: Data Exfiltration
# Identifica conexiones específicas (par origen-destino) que han transferido grandes volúmenes de datos a través de puertos de servicios comunes.
...
# Propósito principal: Unusual Protocol
# Identifica tráfico de red que usa protocolos diferentes a los estándar (TCP, UDP, ICMP) lo cual puede indicar actividad maliciosa, túneles encubiertos o herramientas de evasión.
